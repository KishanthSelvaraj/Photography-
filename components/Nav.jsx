...
const NavBar = () => {
  ...
  return (
    <div>
      ...
      <a href="#" class="flex items-center justify-center text-2xl font-semibold text-black">
        ...
        <div className="menu  w-full hidden md:flex justify-end gap-7 ml-5">
          <ul className="flex gap-7 font-medium">
            ...
            <li className="cursor-pointer">
              <Link href="#ourservices" className="hover:text-[#34b69c]">Services</Link>
            </li>
            <li className="cursor-pointer">
              <Link href="/office" className="hover:text-[#34b69c]">Gallery</Link>
            </li>
            <li className="cursor-pointer">
